(function() {
            ...
            document.querySelectorAll('#studentNavMenu .teacher-nav-item').forEach(function(link) {
                ...
                if (!p) return;
                if (path.startsWith('/student/classroom/') && p === '/student/dashboard') {
            ...
            const iconMap = {
                ...
                'bi-file-earmark-text-fill': 'fa-file-lines',
                ...
                'bi-info-circle-fill': 'fa-circle-info',
                'bi-pencil': 'fa-pen',
                'bi-trash': 'fa-trash',
                'bi-key': 'fa-key',
                'bi-fonts': 'fa-font',
                ...
                'bi-clock': 'fa-clock',
                'bi-clock-history': 'fa-clock-rotate-left',
                ...
                'bi-play-circle': 'fa-circle-play',
                'bi-play-circle-fill': 'fa-circle-play',
                'bi-question-circle': 'fa-circle-question',
                'bi-question-circle-fill': 'fa-circle-question',
                'bi-mortarboard': 'fa-user-graduate',
                'bi-mortarboard-fill': 'fa-user-graduate',
